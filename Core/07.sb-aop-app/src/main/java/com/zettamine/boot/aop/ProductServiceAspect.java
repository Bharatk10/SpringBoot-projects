...
public class ProductServiceAspect {
	...
	@Before(value = "execution(* com.zettamine.boot.aop.service.ProductService.*(..)) and args(productId, productName, productPrice)")
	...
	@Before(value = "execution(* com.zettamine.boot.aop.service.ProductService.*(..))")  
	public void beforeAdvice1(JoinPoint joinPoint) {  
		System.out.println("Before method without arguments:" + joinPoint.getSignature());  		
	}
}
