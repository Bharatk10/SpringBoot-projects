...
//		List<Contact> contacts = contactService.getContactsInAscByContactName();
//		
//		contacts.forEach(System.out::println);
		
//		List<Contact> contacts = contactService.getContactsDescByContactName();
//		
//		contacts.forEach(System.out::println);
		
List<Contact> contacts = contactService.getContactsInAscByContactNameAndContactNumber();
