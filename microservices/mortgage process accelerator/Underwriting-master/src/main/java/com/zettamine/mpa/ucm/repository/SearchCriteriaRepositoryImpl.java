...
//				new BeanPropertyRowMapper<>(SearchResultDto.class));
	...
	public Set<Integer> getLoanProductByCriteria(List<String> criteriaNames) {
		...
		String query = "select prod_id from mpa_demo_uc.underwriting_criteria_loan_prod uctp inner join "
				+ "mpa_demo_uc.underwriting_criteria uct on uctp.criteria_id = uct.criteria_id where 1=1 and "
